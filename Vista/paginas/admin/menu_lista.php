<?php
////////////////generacion del combo////////////////
include_once "../configuracion.php";
$objControl = new MenuController();
...
foreach ($List_Menu as $objMenu) {
    $combo .= '<option value="' . $objMenu->getIdmenu() . '">' . $objMenu->getNombreMenu() . ':' . $objMenu->getMenuDescripcion() . '</option>';
}
