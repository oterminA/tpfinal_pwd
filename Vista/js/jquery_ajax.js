...
function eliminarDelCarrito(idcompraitem, idproducto) { //funcion js con ajax adentro que usa jquery como codigo
    if (confirm("¿Seguro que queres sacar este producto?")) {
        $.ajax({
            ...
            }, //son los datos que se le mandan al action, el idque tengo que eleiminar y qué accion es porque en el action yo uso switch por la cantidad de funcones que voy a manejar así no hago muchos actions
