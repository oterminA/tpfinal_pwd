...
ALTER TABLE `menurol`
  ...
  ADD UNIQUE KEY `uk_menurol` (`idmenu`,`idrol`),
...
ALTER TABLE `usuariorol`
  ...
  ADD UNIQUE KEY `uk_usuariorol` (`idusuario`,`idrol`),
  ADD KEY `fkusuariorol_1` (`idusuario`),
  ADD KEY `fkusuariorol_2` (`idrol`);
...
--
ALTER TABLE `menurol`
  MODIFY `idmenurol` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `usuariorol`
  MODIFY `idusuariorol` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `usuariorol`
  ADD CONSTRAINT `fkusuariorol_1` FOREIGN KEY (`idusuario`) REFERENCES `usuario` (`idusuario`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fkusuariorol_2` FOREIGN KEY (`idrol`) REFERENCES `rol` (`idrol`) ON UPDATE CASCADE;


-- ESTO LO ESTOY AGREGANDO DESPUES XQ ME DI CUENTA QUE SERIA BUENO HACER UN BORRADO LOGICO DE ESTA TABLA Y NO UNO FISICO Q ES LO QUE SE ESTARÍA HACIENDO AHORA
ALTER TABLE rol ADD rodeshabilitado TIMESTAMP NULL DEFAULT NULL;
